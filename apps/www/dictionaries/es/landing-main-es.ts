...
export const landingThemingEs: LandingThemingCopy = {
  ...
  cardDemo: {
    core: {
      ...
      badge: "v2.4",
      profileCard: "Tarjeta de sistema",
      description:
        "Implementacion base sobre primitivos Ark UI, con estructura predecible y cero ataduras.",
      tags: ["Accesible", "Tematizable", "Componible"],
      saved: "★ Guardado",
      save: "☆ Guardar",
      viewDocs: "Ver docs",
      lampAlt: "Lampara decorativa sobre la tarjeta core de ejemplo",
    },
    edge: {
      componentLabel: "MODULO",
      badge: "BETA",
      profileCard: "Panel de accion",
      description:
        "Jerarquia visual marcada para interfaces de alto contraste, pensada para acciones rapidas.",
      tags: ["Reactivo", "Sin estado", "Rapido"],
      saved: "★ Fijado",
      save: "☆ Fijar",
      viewDocs: "Ejecutar",
      lampAlt: "Lampara decorativa sobre la tarjeta edge de ejemplo",
    },
    bloom: {
      componentLabel: "WIDGET",
      badge: "NUEVO",
      profileCard: "Tarjeta de creador",
      description:
        "Capa de composicion expresiva con acentos vivos y lectura clara para flujos creativos.",
      tags: ["Colorido", "Ludico", "Modular"],
      saved: "★ Favorito",
      save: "☆ Favoritar",
      viewDocs: "Explorar",
      lampAlt: "Lampara decorativa sobre la tarjeta bloom de ejemplo",
    },
    ether: {
      componentLabel: "ELEMENTO",
      badge: "ALPHA",
      profileCard: "Lente de datos",
      description:
        "Presentacion tipo glass para contextos por capas, con foco visual y poco ruido cromatico.",
      tags: ["Fluido", "Minimal", "Por capas"],
      saved: "★ En seguimiento",
      save: "☆ Seguir",
      viewDocs: "Inspeccionar",
      lampAlt: "Lampara decorativa sobre la tarjeta ether de ejemplo",
    },
    drift: {
      componentLabel: "BLOQUE",
      badge: "ESTABLE",
      profileCard: "Feed de actividad",
      description:
        "Composicion redondeada y adaptable para lectura comoda en contenido largo y mixto.",
      tags: ["Adaptable", "Suave", "Semantico"],
      saved: "★ Siguiendo",
      save: "☆ Seguir",
      viewDocs: "Detalles",
      lampAlt: "Lampara decorativa sobre la tarjeta drift de ejemplo",
    },
  },
};
