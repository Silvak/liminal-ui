...
![New documentation layout](/docs/docs-layout.svg "Modern documentation layout with sidebar, content, and table of contents")

<Callout type="tip" title="Recommended approach">
  Start with the installation section, then go through one component family at a time.
  This speeds up adoption without forcing a full migration.
</Callout>
  ...
  data={[
    {
      ...
      type: '"default" | "custom"',
      default: '"default"',
      description: "Style profile applied by the CLI in components.json.",
    },
    {
      prop: "tsx",
      type: "boolean",
      default: "true",
      description: "Whether components are generated as TypeScript files.",
    },
    {
      prop: "rsc",
      type: "boolean",
      default: "false",
      description: "Enables adjustments for React Server Components.",
    },
  ]}
/>
